...
This was a big challenge over the years, based on a bug in how font files were exported. It was recently fixed, so if you follow these simple guidelines, fonts should be recognized as a family:
